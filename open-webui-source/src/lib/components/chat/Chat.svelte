<script lang="ts">
	...
	import VideoGenerationModal from './VideoGenerationModal.svelte';
	...
	let showVideoGenerationModal = false;
...
<VideoGenerationModal bind:show={showVideoGenerationModal} />
