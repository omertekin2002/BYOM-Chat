<script lang="ts">
	...
	export let onVideoGeneration: Function = () => {};
			...
			{#if tab === ''}
				<div in:fly={{ x: -20, duration: 150 }}>
					...
					{#if showVideoGenerationButton}
						<Tooltip content={$i18n.t('Generate a video with Sora')} placement="top-start">
							<button
								class="flex w-full justify-between gap-2 items-center px-3 py-1.5 text-sm cursor-pointer rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800/50"
								on:click={() => {
									onVideoGeneration();
							...
							>
									...
									<div class="flex flex-1 gap-2 items-center">
										<div class="shrink-0">
											...
											>
												<path
													fill-rule="evenodd"
													d="M2 4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V4Zm3.5 1a.5.5 0 0 0-.5.5v5a.5.5 0 0 0 .757.429l4-2.5a.5.5 0 0 0 0-.858l-4-2.5A.5.5 0 0 0 5.5 5Z"
													clip-rule="evenodd"
												/>
											</svg>
										</div>
								...
								<div class=" shrink-0 text-xs text-gray-500">Sora</div>
							</button>
						</Tooltip>
					{/if}
