...
VIDEO_GENERATION_MODEL = PersistentConfig(
    ...
    os.getenv("VIDEO_GENERATION_MODEL", "sora-2"),
)

VIDEO_DURATION = PersistentConfig(
    "VIDEO_DURATION",
    "video_generation.duration",
    os.getenv("VIDEO_DURATION", "4"),
)

VIDEO_SIZE = PersistentConfig(
    "VIDEO_SIZE",
    "video_generation.size",
    os.getenv("VIDEO_SIZE", "1920x1080"),
)

VIDEO_QUALITY = PersistentConfig(
    "VIDEO_QUALITY",
    "video_generation.quality",
    os.getenv("VIDEO_QUALITY", "standard"),
)
